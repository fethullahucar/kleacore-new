...
const statusFilters = [
  { value: "all", label: "Tümü", count: 2847 },
    ...
    <div className="space-y-6">
      ...
      <BlurFade delay={0}>
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-zinc-900 dark:text-white">Müşteriler</h1>
            <p className="text-zinc-600 dark:text-zinc-400">Tüm müşterilerinizi yönetin</p>
          </div>
          <Button asChild className="bg-primary hover:bg-primary/90">
            <Link href="/yonetim/musteri-ekle">
