...
const services = [
  ...
  },
  {
    id: "H-015",
    customerId: "M-015",
    customerName: "Hasan Demir",
    domain: "hasandemir.com",
    category: "vps",
  ...
  },
  {
    ...
    domain: "gizemaksoy.com.tr",
    category: "email",
    packageName: "Profesyonel E-posta",
    status: "suspended",
  ...
  },
  {
    id: "H-018",
    customerId: "M-018",
    customerName: "Selim Korkmaz",
    companyName: "Korkmaz İnşaat",
    domain: "korkmaz.com.tr",
    category: "vds",
    packageName: "VDS Large",
    status: "suspended",
...
const reasonFilters = [
  { value: "all", label: "Tüm Nedenler", count: 234 },
  { value: "payment", label: "Ödeme Gecikmesi", count: 189, color: "text-orange-500" },
  { value: "violation", label: "Kullanım İhlali", count: 32, color: "text-yellow-500" },
  { value: "fraud", label: "Dolandırıcılık", count: 13, color: "text-red-500" },
];
    ...
    <div className="space-y-6">
      ...
      <BlurFade delay={0}>
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-zinc-900 dark:text-white">Askıdaki Hizmetler</h1>
            <p className="text-zinc-600 dark:text-zinc-400">Askıya alınan hizmetlerin listesi</p>
          </div>
                    ...
                    <tr>
                      <td colSpan={6} className="p-8 text-center">
                        <div className="flex flex-col items-center gap-2">
                          ...
                          <p className="text-zinc-500 dark:text-zinc-400">Askıdaki hizmet bulunamadı</p>
                    ...
                    filteredServices.map((service) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="p-4">
                            <div>
                              <p className={cn("text-sm font-medium", reasonConfig[service.reason].color)}>
                                {reasonConfig[service.reason].label}
                              </p>
                              {service.daysOverdue > 0 && (
                                <p className="text-xs text-red-500 mt-0.5">{service.daysOverdue} gün gecikmiş</p>
                              )}
                            </div>
                          </td>
                          <td className="p-4">
                            <span className={cn(
                              "text-sm font-medium",
                              service.overdueAmount > 0 ? "text-red-500" : "text-zinc-500"
                            )}>
                              {service.overdueAmount > 0 ? formatPrice(service.overdueAmount) : "-"}
                            </span>
                          </td>
                          <td className="p-4">
                            <span className="text-sm text-zinc-600 dark:text-zinc-400">
                              {new Date(service.suspendedAt).toLocaleDateString("tr-TR")}
                            </span>
                          </td>
