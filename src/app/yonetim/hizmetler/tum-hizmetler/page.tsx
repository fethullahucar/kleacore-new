    ...
    <div className="space-y-6">
      ...
      <BlurFade delay={0}>
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-zinc-900 dark:text-white">Tüm Hizmetler</h1>
            <p className="text-zinc-600 dark:text-zinc-400">Sistemdeki tüm hizmetlerin listesi</p>
          </div>
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-blue-500/10">
            <ListOrdered className="h-5 w-5 text-blue-500" />
            <span className="text-sm font-medium text-blue-500">3,847 Hizmet</span>
          </div>
        </div>
      </BlurFade>
