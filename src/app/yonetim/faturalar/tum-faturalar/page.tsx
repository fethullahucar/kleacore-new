...
export default function AllInvoicesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <BlurFade delay={0}>
        <div>
          <h1 className="text-2xl font-bold text-zinc-900 dark:text-white">Tüm Faturalar</h1>
          <p className="text-zinc-600 dark:text-zinc-400">Sistemdeki tüm faturaların listesi</p>
        </div>
      </BlurFade>
          ...
          <Card className="bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800">
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-zinc-600 dark:text-zinc-400">Toplam Fatura</p>
                  <p className="text-xl font-bold text-zinc-900 dark:text-white">{totalInvoices}</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800">
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-zinc-600 dark:text-zinc-400">Tahsil Edilen</p>
                  <p className="text-xl font-bold text-zinc-900 dark:text-white">{formatPrice(paidAmount)}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-zinc-900 dark:text-white">{statusCounts.pending + statusCounts.overdue}</p>
                </div>
              </div>
            </CardContent>
          </Card>
