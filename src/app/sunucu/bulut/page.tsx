...
const cloudPlans = [
  {
    ...
    ram: "4 GB",
    disk: "80 GB",
    traffic: "Sınırsız Trafik",
    port: "10 Gbps Port",
    monthlyPrice: 359.00,
    discountedMonthly: 299.00,
    yearlyPrice: 3011.00,
  },
  {
    name: "Cloud-M",
  ...
  },
  {
    ...
    traffic: "Sınırsız Trafik",
    port: "10 Gbps Port",
    monthlyPrice: 1199.00,
    discountedMonthly: 999.00,
    yearlyPrice: 10070.00,
  },
  {
    name: "Cloud-XL",
    cpu: "16 vCPU",
    ...
    traffic: "Sınırsız Trafik",
    port: "10 Gbps Port",
    monthlyPrice: 2279.00,
    discountedMonthly: 1899.00,
    yearlyPrice: 19142.00,
  },
];
...
const planFeatures = [
  ...
  { icon: Globe, text: "Sınırsız Trafik" },
  { icon: MapPin, text: "İstanbul Lokasyon" },
  { icon: Cpu, text: "AMD EPYC" },
...
export default function BulutSunucuPage() {
            ...
            <BlurFade delay={0.1} inView>
              <div className="text-center mb-12">
                ...
                <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
                  Esnek, ölçeklenebilir ve yüksek performanslı bulut sunucu çözümleri.
                  İhtiyacınıza göre anında kaynak yönetimi.
                </p>
              </div>
            </BlurFade>
