...
export function AdminHeader() {
  ...
  return (
    <header className="sticky top-0 z-30 h-16 bg-zinc-900/95 backdrop-blur border-b border-zinc-800">
      <div className="flex h-full items-center justify-between px-6">
        ...
        <div className="relative w-full max-w-md">
          ...
          <Input
            type="search"
            placeholder="Müşteri, hizmet veya fatura ara..."
            value={searchQuery}
        ...
        <div className="flex items-center gap-2">
              ...
              <div className="max-h-80 overflow-y-auto">
                {notifications.map((notification) => (
                  ...
                  >
                    ...
                    <span className="text-sm text-zinc-400">{notification.description}</span>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="flex items-center gap-2 text-zinc-400 hover:text-white hover:bg-zinc-800">
            ...
            <DropdownMenuContent align="end" className="w-48 bg-zinc-900 border-zinc-800">
              ...
              <DropdownMenuItem asChild className="cursor-pointer hover:bg-zinc-800 text-red-400">
